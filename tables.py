...
class Table1:
    ...
    def table(self, codes: dict, results: dict) -> list:
        ...
        res.insert(0, ['Технічні прийоми', *['Вік 13-15 років, разів за гру']*4, 
                    *['Вік 16-17 років, разів за гру']*4, *['Вік 18-19 років, разів за одну гру']*4])
...
class Table2:
    ...
    def table(self, codes: dict, results: dict, code_tech: str, codes_to_show: list) -> list:
